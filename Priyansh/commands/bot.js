...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "Bot Teri Ma") || (event.body.toLowerCase() == "Bot Madrchod")) {
     return api.sendMessage("Sale Bhikhari Ke Bache Ma Chod Dunga Teri 😝", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Hahaha") || (event.body.toLowerCase() == "Haha")) {
     return api.sendMessage("Hass Kya Raha Hai Gb Roud Ki Olad Bhosdike😂", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Iski") || (event.body.toLowerCase() == "Randi")) {
     return api.sendMessage("Han DoSt Apki Ma Randi He Or Usko Randi Banane Wala Me Hi Hu ❤️", threadID);
   };

   if ((event.body.toLowerCase() == "mc") || (event.body.toLowerCase() == "Bhosdike") || (event.body.toLowerCase() == "Teri") || (event.body.toLowerCase() == "Ma")) {
     return api.sendMessage( "Le Tmkc Par Mithi Mithi Kiss Ab Sant Hoja 😘",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:- PRINCE", threadID);
   };

   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "Local")) {
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "Teri Ma Ki Chut")) {
   ...
   if ((event.body.toLowerCase() == "shadi karoge") || (event.body.toLowerCase() == "Madrchod Hai")) {
